...
All the environments are registered in the `Clutter` extension. They start
...
import Clutter.tasks  # noqa: F401


def main():
    """Print all environments registered in `Clutter` extension."""
