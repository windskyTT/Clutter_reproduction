...
def _require_pynvml():
    """Raise a clear error when optional GPU monitoring support is unavailable."""

    if pynvml is None:
        raise ModuleNotFoundError("GPU usage helpers require optional dependency `pynvml` and a loaded CUDA driver.")
